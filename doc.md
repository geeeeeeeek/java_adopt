...
一直想做一款宠物领养管理系统，看了很多优秀的开源项目但是发现没有合适的。于是利用空闲休息时间开始自己写了一套管理系统。学习过程中遇到问题可以咨询微信：lengqin1024 或者发Email: kefu308@gmail.com

## 在线体验


- 代码下载：https://github.com/geeeeeeeek/java_adopt
...
- 宠物管理：管理系统可以录入、修改和查询宠物的基本信息，如宠物姓名、性格、备注等。
...
```
CREATE DATABASE IF NOT EXISTS java_adopt DEFAULT CHARSET utf8 COLLATE utf8_general_ci
```
(4) 恢复sql数据。在mysql下依次执行如下命令：

```
mysql> use java_adopt;
mysql> source D:/xxx/xxx/java_adopt.sql;
```
            ...
            <a-row :gutter="24">
              ...
              <a-col span="24">
                <a-form-item label="昵称">
                  <a-input placeholder="请输入" v-model:value="modal.form.nickname" style="width: 100%" />
                </a-form-item>
              </a-col>
              <a-col span="12">
